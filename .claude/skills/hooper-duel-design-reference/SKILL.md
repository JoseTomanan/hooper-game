...
| **Layup / rim-finish** | The rim-finishing vertical's contestable close finish (#229; **not yet built as of 2026-07-17**) — a distinct committed move from `JumpShot`, released from under/at the rim with its own Startup/Active/Recovery, feeding the SAME distance/scatter make model ADR-0009 already established (no parallel accuracy formula) and contestable by the EXISTING block timing window (#98/#214) with no new defensive primitive. Real half-court ball, tier 2: the basic close-range finish, high% when open, blockable when contested — ADR-0009's own ≤3m≈100% anchor already encodes this numerically; the layup gives it its own move to attach to. 2K, tier 4, taxonomy only (zero feel weight): "layup" is 2K's name for this shot family. | ADR-0022, ADR-0009 (make model reused, not amended), issue #229 |
| **Drive-gather** | A committed forward gather-step that plants the player onto a drive line toward the rim (#230; **not yet built as of 2026-07-17**), the moment of commitment a drive (and the euro-step) is a variant of — the drive's own version of the shooting cradle (`CradleForShotStartup`). Startup bleeds pre-existing lateral velocity via the SAME hybrid-gather momentum model Crossover/BehindTheBack use (#198), opted in per #198's own "opt-in for future burst-family moves" framing, not a third momentum scheme. Real half-court ball, tier 2: the committed instant a driving ball-handler picks up their dribble to attack the rim. Undisputed 3, tier 3: the momentum-carries-into-commitment model (body doesn't teleport-stop) IS the Undisputed 3 legibility pattern #198 already modeled. | ADR-0022, ADR-0003 #198 amendment, issue #230 |
| **Euro-step** | The lateral evasive gather-step used while driving, to sidestep a defender's outstretched block attempt en route to a finish (#231; **not yet built, gated `blocked` on #229+#230 as of 2026-07-17**) — the original #203 content. Reuses BehindTheBack's exit-cone precedent (#194): a clamped lateral exit angle at Active-entry is the entire mechanism for "narrower, evasive variant of the drive-gather," not a longer Recovery or a cooldown (both rejected for BehindTheBack on the same grounds, and the reasoning transfers). Real half-court ball, tier 2: real evasive footwork, not an invented mechanic. 2K, tier 4, taxonomy only: 2K's own name for this exact move, adopted verbatim; 2K's feel for it (auto-triggered animation packages) carries zero weight. | ADR-0022, ADR-0003 #194 amendment, issue #231 (part of umbrella #203) |
...
**Glossary updated 2026-07-17** (issue #232): added Layup/rim-finish,
Drive-gather, and Euro-step entries recording the rim-finishing offensive
vertical un-deferred by ADR-0022 (#203 umbrella). All three are cited as
**not yet built** as of this date — verify with
`gh issue view 229/230/231 -R JoseTomanan/hooper-game` before treating any
of them as shipped.
