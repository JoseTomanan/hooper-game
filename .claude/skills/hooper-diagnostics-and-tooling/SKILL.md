...
bash .claude/skills/hooper-diagnostics-and-tooling/scripts/run-harness-local.sh list
bash .claude/skills/hooper-diagnostics-and-tooling/scripts/run-harness-local.sh list --tag multiprocess
bash .claude/skills/hooper-diagnostics-and-tooling/scripts/run-harness-local.sh run --all --godot "$GODOT"
bash .claude/skills/hooper-diagnostics-and-tooling/scripts/run-harness-local.sh run --scene BlockTurnoverTest.tscn --godot "$GODOT"
```
