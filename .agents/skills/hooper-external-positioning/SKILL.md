...
- Autonomous merge is real and gated: `.Codex/agents/orchestrator.md` +
  `.Codex/agents/issue-worker.md` implement dispatch→review→merge with
...
- **Agentic coding tools generally** (Codex, Devin, Cursor agents,
