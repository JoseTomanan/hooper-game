...
drift on the string** (as of 2026-07-12): `.Codex/agents/issue-worker.md`
hardcodes `Co-Authored-By: Codex Opus 4.8 <noreply@anthropic.com>`, while
...
that drift is its own change, owned by whoever owns `.Codex/agents/`.
...
- Trailer convention in force: your running session's system instructions,
  not `.Codex/agents/issue-worker.md`
